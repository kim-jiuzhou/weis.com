...
<html>
<head>
	<title>Wanfang Inventory System</title>
 <meta charset="utf-8">
...
<nav class="navbar navbar-inverse" style="margin-top:5px;">
    <div class="container-fluid">
     <div class="banner">
                   <img src="./img/logo.png" width="200" height="100" style="position:absolute;margin-top:-30px;">
<div style="color:white;margin-left:250px;margin-bottom:40px;margin-top:40px;font-size:30px;font-family:Bodoni MT Black;">WANFANG INVENTORY SYSTEM</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h2 class="modal-title text-center">Administrator</h4>
			</div>
